...
import com.arka.report.domain.exception.dto.ApiRespuestaExcepcionDTO;
...
public class ApiManejadorExcepcionesGlobal {
	...
	public ResponseEntity<ApiRespuestaExcepcionDTO> manejadorValidacionPeticionesException(ReportException validacionPeticionesExcepcion){
