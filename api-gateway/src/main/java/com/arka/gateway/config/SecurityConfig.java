    ...
    public SecurityWebFilterChain securityWebFilterChain(
        ...
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(HttpMethod.GET, "/carts/abandoned").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.POST, "/carts/*/reminder").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.POST, "/carts").hasAnyRole("CLIENT", "ADMIN")
                        .pathMatchers(HttpMethod.GET, "/notifications/orders/*").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.POST, "/notifications/cart-reminders").hasRole("ADMIN")
